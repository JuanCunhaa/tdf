...
export default function AdminSubmissions(){
  ...
  async function approve(id:string){
    setErr(null);
    try{ await api(`/submissions/${id}/approve`, { method:'POST' }, token!); load(); }
    catch(e:any){ setErr(e.message || 'Erro ao aprovar. Verifique se há evidências.'); }
  }
  async function reject(id:string){
    setErr(null);
    try{ await api(`/submissions/${id}/reject`, { method:'POST' }, token!); load(); }
    catch(e:any){ setErr(e.message || 'Erro ao rejeitar.'); }
  }
